...
INDEX_DISPLAY_NAME = "doc_all_embedding_profile_index"
DEPLOYED_INDEX_ID = "doc_all_embedding_deployed"  # Must be unique and contain only letters, numbers, or underscores
